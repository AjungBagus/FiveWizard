package org.games;
public class GreenWizard extends Wizard implements Skill {
    public GreenWizard() {
        super("Green Wizard", 100);
    }
    ...
    private void applyDamage(Wizard target, int baseDamage) {
        ...
        if (target instanceof BlueWizard){ damage = baseDamage; // Damage penuh
        ...
        } else if (target instanceof RedWizard) {
